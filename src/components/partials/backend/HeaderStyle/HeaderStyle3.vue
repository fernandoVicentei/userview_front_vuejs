        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="iq-menu-horizontal">
                <nav class="iq-sidebar-menu">
                    ...
                    <CollapseMenu :items="sidebarItems" :open="true" :horizontal="false"  className="iq-menu d-flex collapse-menu"/>
                    <HoverMenu :items="sidebarItems" :sidebarGroupTitle="sidebarGroupTitle" className="iq-menu d-flex hover-menu" />
                </nav>
            </div>
                                            ...
                                            <div class="media align-items-center mb-4">
                                                ...
                                                <div class="media-body profile-detail ml-3 rtl-mr-3 rtl-ml-0">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        <p class="mb-1">Web designer</p> <router-link :to="{name: 'auth.login'}" class="ml-3 rtl-mr-3 rtl-ml-0">Sign Out</router-link>
                                                    </div>
                                                </div>
                                            </div>
...
<style scoped lang="scss">
  .iq-sidebar-menu .iq-menu.collapse-menu{
